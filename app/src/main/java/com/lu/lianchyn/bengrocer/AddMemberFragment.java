...
public class AddMemberFragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View v =  inflater.inflate(R.layout.fragment_add_member, container, false);
        ...
        member_count = Integer.parseInt(bundle.get("member_count").toString());
    ...
    public void onClick(View v){
        switch(v.getId()) {
            case R.id.create:
                ...
                final String mid = "M" + String.format("%06d", member_count + 1);
                if(
                    ...
                    db.collection("Member").document(mid)
                            ...
                            .addOnSuccessListener(new OnSuccessListener<Void>() {
                                ...
                                public void onSuccess(Void aVoid) {
                                        ...
                                        Toast.makeText(getActivity().getBaseContext(), "New member created successfully.", Toast.LENGTH_LONG).show();
                                }
                            })
