...
public class EditStaffFragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View v =  inflater.inflate(R.layout.fragment_edit_staff, container, false);
        ...
        switch(position) {
            case "Manager":
                snPosition.setSelection(0);
                break;
            case "Inventory Staff":
                snPosition.setSelection(1);
                break;
            case "Cashier":
                snPosition.setSelection(2);
                break;
        }
    ...
    public void onClick(View v){
        switch(v.getId()) {
            case R.id.submit:
                ...
                break;
            case R.id.reset:
                etAddress.setText(this.address);
                etIc.setText(this.ic);
